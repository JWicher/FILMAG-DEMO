...
router.post('/', checkPermission("Admin"), async (req, res) => {
    ...
    // Logger.info(`Successfully added localisation: ${localisation._id}`, req.user)
...
router.put('/:id', async (req, res) => {
    ...
    // Logger.info(`Successfully updated localisation: ${localisation._id}`, req.user)
...
router.delete('/:id', checkPermission("Admin"), async (req, res) => {
    ...
    // Logger.info(`Successfully deleted localisation: ${localisation._id}`, req.user)
