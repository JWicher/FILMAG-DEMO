...
const FinishGood = React.memo((props) => {
    ...
    const rederRegistrationData = (finishGood, column) =>{
        return (
            <React.Fragment >
                <div className={`finishGood-box__finishGood_${column.path}-full`}>{finishGood.createdAtFormatedData}</div>
                <div className={`finishGood-box__finishGood_${column.path}-splitted`}>
    ...
    return (
            <div
                ...
                >
                {columns.map(column =>
                    <div key={finishGood._id + column.path} className={`finishGood-box__finishGood_${column.path}`}>
